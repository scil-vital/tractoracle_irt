...
scil_tractogram_segment_with_ROI_and_score.py $tractogram $config_file_segmentation $out_dir --no_empty \
    --gt_dir $scoring_data --reference $ref --json_prefix tmp_ --no_bbox_check --compute_ic --unique;
...
echo '------------- FINAL SCORING ------------'
scil_bundle_score_many_bundles_one_tractogram.py -v INFO $config_file_tractometry $out_dir \
