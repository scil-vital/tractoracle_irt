...
def print_colored(text, color='reset', print_func=print):
    color_code = bcolors.__dict__.get(color.upper(), bcolors.ENDC)
    print_func(f"{color_code}{text}{bcolors.ENDC}")

from argparse import ArgumentDefaultsHelpFormatter, RawDescriptionHelpFormatter
class ArgparseFullFormatter(ArgumentDefaultsHelpFormatter, RawDescriptionHelpFormatter):
    pass