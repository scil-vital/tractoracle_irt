...
# THIS WAS COPIED FROM: https://github.com/ludvb/batchrenorm/blob/master/batchrenorm/batchrenorm.py
# THE INTENTION BY COPYING THIS WAS ONLY TO TEST QUICKLY. IF THE USAGE OF THIS REMAINS, THEN THIS
# SHOULD BE REIMPLEMENTED OR REFERENCED THE RIGHT WAY.
